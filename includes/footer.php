        ...
        <ul id="slide-out" class="sidenav">
            <li>
                <div class="user-view z-depth-2" style="background-color: rgb(168, 51, 51);">
                    <img src="images/newsimg1.jpg" class="responsive-img" style="opacity: 95%; height:160px; width:160px; background-position: center ; margin-left:19% ; padding-right:0px;">
                </div>
            </li>
            <li>
